...
# Summary/Abstract
This is the Module 2 Exercise for Group 3. 
...
Figure \@ref(fig:resultfigure1) shows a scatterplot figure produced by one of the R scripts. Figure \@ref(fig:resultfigure2) shows a scatterplot figure examining a new numerical variable, systolic blood pressure, vs. weight. Figure \@ref(fig:resultfigure3) shows a boxplot figure examining height vs a new categorical variable, mode of arrival. 
...
```{r resultfigure2, fig.cap='Systolic Blood Pressure vs. Weight', echo=FALSE}
knitr::include_graphics("../../results/scatterplotfigure.png")
```


```{r resultfigure3, fig.cap='Height vs. Mode of Arrival', echo=FALSE}
knitr::include_graphics("../../results/boxplotfigure.png")
```
